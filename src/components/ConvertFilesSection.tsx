...
import { Upload, FileText, Image, FileVideo, Music, Archive, Download, Sparkles, ArrowRight, Cloud, Zap, Shield } from 'lucide-react';
...
const ConvertFilesSection: React.FC<ConvertFilesSectionProps> = ({ onFileSelect }) => {
  ...
  const formatOptions = [
    ...
    { value: 'jpg', label: 'JPG', icon: Image, color: 'from-yellow-500 to-yellow-600' },
              ...
              {!selectedFile ? (
                <>
                  ...
                  <div className="flex flex-wrap justify-center gap-2 mb-8 text-sm text-gray-400">
                    ...
                    <span className="px-3 py-1 bg-white/50 rounded-full">MP4</span>
                    <span className="px-3 py-1 bg-white/50 rounded-full">And More...</span>
                  </div>
